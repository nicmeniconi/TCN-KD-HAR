...
# import utils.modeling2 as models
from utils.loadutils9 import *
from utils.loadutils4 import *
...
def main():
    ...
    teacher_name = f'/Volumes/Data_Drive/vidimu_gridsearch_out/gridsearch_11_4/best_AngPos_ResNet_fold1_{args.depth}_{args.secs}_{args.seed}_acc_'
    teacher_path = glob.glob(teacher_name+'*')[0]
    # print('TEACHER PATH ------> ', teacher_path)
    student_name = f'/Volumes/Data_Drive/vidimu_gridsearch_out/gridsearch_11_4/best_Pos_ResNet_fold1_{args.depth}_{args.secs}_{args.seed}_acc_'
